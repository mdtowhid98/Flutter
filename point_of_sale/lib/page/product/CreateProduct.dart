...
class _CreateProductState extends State<CreateProduct> {
  ...
  Future<void> _fetchData() async {
    try {
      ...
      // Reset the selected values if the corresponding lists have items
      if (categories.isNotEmpty) {
        selectedCategory = categories.first.categoryname; // Set a default
      }
      if (suppliers.isNotEmpty) {
        selectedSupplier = suppliers.first.name; // Set a default
      }
      if (branches.isNotEmpty) {
        selectedBranch = branches.first.branchName; // Set a default
      }
