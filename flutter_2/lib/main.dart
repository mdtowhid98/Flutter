      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 15), // Spacing between TextFields
            TextField(
              decoration: InputDecoration(
                border: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(10),
              ...
              child: ElevatedButton(
                style: elevatedButtonStyle.copyWith(
                  padding: MaterialStateProperty.all<EdgeInsets>(
                    EdgeInsets.symmetric(horizontal: 40, vertical: 15), // Adjust padding
                  ),
                ),
                onPressed: () {
                  MySnackBar("Submitted", context); // Feedback on submission
                },
